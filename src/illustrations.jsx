...
const images = [
  ...
  { src: ill2, caption: "TREE HOUSE STORIES" },
  { src: ill3, caption: "TOR SOHORE" },
  { src: ill4, caption: "THE BRO" },
  { src: ill05, caption: "DEAR VIENNA" },
  { src: ill5, caption: "FELUDAR POR" },
  { src: ill06, caption: "COMFORTABLE SILENCE" },
  { src: ill6, caption: "BENGALI PHRASE" },
  { src: ill7, caption: "MODEL & MEW" },
  { src: ill8, caption: "AKASHLEENA" },
  { src: ill9, caption: "BARISH" },
  { src: ill10, caption: "HIS EYES" },
  { src: ill11, caption: "🎵IF I SAW YOU IN HEAVEN" },
  { src: ill12, caption: "COLORFUL COMPANY" },
  { src: ill13, caption: "SAUDADE" },
  { src: ill14, caption: "CHILTE RODE" },
  { src: ill16, caption: "BAROI MAY" },
  { src: ill17, caption: "WINTER NIGHTS" },
  { src: ill18, caption: "CITY LIGHTS" },
  { src: ill20, caption: "SWEETS" },
  { src: ill1, caption: "LIFE IS BEAUTIFUL" },
  { src: ill21, caption: "SPRING NIGHTS IN ME" },
  { src: ill25, caption: "LADDOO" },
  { src: ill26, caption: "GUNS N ROSES" },
  { src: ill29, caption: "RAIN WASHES AWAY" },
  { src: ill34, caption: "HOME" },
  { src: ill35, caption: "IMPERISHABLE SOUL" },
  { src: ill36, caption: "THE STRANGER WITH HIS KITTY" },
  { src: ill43, caption: "DIWALI" },
  { src: ill44, caption: "DRIZZLING" },
  { src: ill45, caption: "KHONA" },
  { src: ill46, caption: "MAO" },
  { src: ill47, caption: "SHAPLA PUKUR" },
  { src: ill49, caption: "KARA SEVDA" },
  { src: ill50, caption: "THE NYPD POLICEMAN" },
  { src: ill52, caption: "PORTRAIT" },
  { src: ill19, caption: "THE BOATMAN" },
  { src: ill54, caption: "TINY MEW" },
  { src: ill55, caption: "DELIBAL" },
  { src: ill56, caption: "THE OCEAN" },
];
